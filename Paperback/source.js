...
exports.PaperbackInfo = {
    ...
    name: 'Paperback Fork',
    icon: 'icon.png',
    author: 'Lemon | Faizan Durrani | Akamura Asai',
    authorWebsite: 'https://github.com/akamuraasai',
...
class Paperback extends types_1.Source {
    ...
    async getMangaDetails(mangaId) {
        ...
        const manga = App.createSourceManga({
            id: mangaId,
        ...
        const request2 = App.createRequest({
            url: `https://komga.akamuraasai.dev/api/v2/series/${mangaId}/read-progress/tachiyomi`,
            method: 'GET'
        });
        ...
        const result2 = typeof response2.data === 'string'
            ...
            : response2.data;
        App.createMangaProgress({
            mangaId: mangaId,
            lastReadChapterNumber: result2.booksReadCount,
        });
        return manga;
    }
